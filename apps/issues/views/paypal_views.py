...
from apps.issues.services import paypal_services, mail_services
import logging
import traceback
...
def payOffer(request, offer, payment):
    # return paypal_adapter.generate_paypal_payment(payment, request)
    ...
    try:
        form_data = paypal_adapter.generate_paypal_payment(payment, request)
    ...
    return render(request, 'sandbox/process_payment.html', {'order': {}, 'form': form_data})
